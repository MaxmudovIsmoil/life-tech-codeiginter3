...
<div class="content ml-3">
      <?= form_open("ishreja/ish_reja_add", array("class" => "needs-validation","novalidate" => "novalidate")) ?>
        <div class="row">
          <div class="col-md-3 mb-4">
            <label for="mavzu">Mavzu</label>
            <input type="text" class="form-control" id="mavzu" name="mavzu" placeholder="" value="<?= set_value("mavzu") ?>" required>
