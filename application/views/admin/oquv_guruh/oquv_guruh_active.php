	...
	<div class="card">
			...
			<div class="row ml-2 mr-1">
				<div class="col-md-12">
					<ul class="nav nav-tabs">
						...
						<li class="nav-item">
							<a class="nav-link <?= $this->uri->segment(2) == "oquv_guruh_tugatilgan" ? "active":""; ?>" href="<?= site_url("oquv_guruh/oquv_guruh_tugatilgan/".$kurs_one['id']); ?>">Tugatilgan</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="card-body">
			<table id="example1" class="table table-bordered table-striped">
				...
				<tbody>
				<?php $i=1; foreach ($oquv_group as $k => $og): ?>
					<tr style="background: <?php if($og['status']==1){ echo '#ddf386'; }elseif($og['status']==2){echo '#9ae9bd'; }else{ echo '#efb88b';} ?>" class="align-middle">
						...
						<td class="align-middle">
							<span class="badge badge-pill badge-info guruh_nomi js_guruh_nomi"
								  data-url="<?= site_url("oquv_guruh/ajax_oquv_guruh_student/".$og['id']); ?>"
								  data-toggle="modal" data-target=".guruh_model">
								<?= $og['guruh_nomi']; ?>
							</span>
						</td>
						<td class="align-middle" style="font-size: 14px;">
							<?php if($og['duy']){ echo "Dushanba,"; }else{ null;} ?>
							<?php if($og['sey']){ echo "Seshanba,"; }else{ null;} ?>
						...
						<td class="align-middle"><?php
							...
							?></td>
						<td class="align-middle" style="font-size: 14px;"><?=$og['teacher_fam'];?> <?=$og['teacher_ism']; ?></td>
						<td class="align-middle" style="font-size: 14px;">
							<?= ($og['turi']==1) ? "Indvidual" : "Guruh"; ?>
							<span class="badge badge-secondary"><?= $og["student_soni"]; ?>
						</td>
						<td class="align-middle" style="font-size: 14px;">
						...
						<td class="text-right py-0 align-middle">
							<div class="btn-group btn-group-sm">
								<a href="<?= site_url("oquv_guruh/oquv_guruh_view_student_add/".$kurs_one['id']."/".$og['id']."/".date('H:i', strtotime($og['soat']))); ?>" class="btn btn-success" title="Guruhga o'quvchi biriktirish" data-toggle="tooltip" data-placement="top">
                                    <i class="fas fa-user-plus"></i>
                                </a>
								<a href="<?= site_url("oquv_guruh/oquv_guruh_view_this/".$kurs_one['id']."/".$og['id']); ?>" class="btn btn-info" title="To'liq ko'rish" data-toggle="tooltip" data-placement="top">
                                    <i class="fas fa-eye"></i>
                                </a>

								<a href="<?= site_url("oquv_guruh/oquv_guruh_edit/".$kurs_one['id']."/".$og['id']); ?>" class="btn btn-primary" title="Tahrirlash" data-toggle="tooltip" data-placement="top">
