  ...
  <div class="content ml-2">
    <div class="row">
        <div class="col-md-11 ml-2">
          <?= form_open("courses/kurs_add", array("class" => "needs-validation","novalidate" => "novalidate")) ?>
            <div class="row">
              <div class="col-md-4 mb-4">
                <label for="nomi">Nomi</label>
                <input type="text" class="form-control" id="nomi" name="nomi" placeholder="" value="<?= set_value("nomi") ?>" required>
                <div class="invalid-feedback">
                  Kurs nomini kiriting
                </div>
                <!-- <label for="price" class="mt-3">Narxi</label>
                <input type="text" class="form-control" id="price" name="price" placeholder="" value="<?= set_value("price") ?>" required>
                <div class="invalid-feedback">
