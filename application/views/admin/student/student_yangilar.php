...
<div class="content-wrapper">
    ...
    <div class="card">
            ...
            <div class="row ml-2 mr-1 mt-2">
                <div class="col-md-12">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= site_url("student/student_yangilar"); ?>">Yangi kelgan o'quvchilar</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="card-header">
            <a class="btn btn-primary" href="<?= site_url("student/student_create"); ?>" style="font-weight: bold;"><i class="fas fa-plus"></i> Qo'shish</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
