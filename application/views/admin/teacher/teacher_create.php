      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="<?= site_url("teacher/") ?>">O'qtuvchi</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content ml-3">
    <div class="row">
        <div class="col-md-8 order-md-1">
          ...
          <?= form_open_multipart("teacher/teacher_create", array("class" => "needs-validation", "novalidate" => "novalidate"), array("type"=>2)) ?>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                  <label for="pasport_file">Pasport nusxa</label> <i>*</i>
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                <label for="email">Email </label> <i>*</i>
                <input type="text" class="form-control" id="email" name="email" placeholder="you@example.com" value="<?= set_value("email") ?>">
                <div class="invalid-feedback">
                  Emailni kiriting.
                </div>
              </div>
              <div class="col-lg-4 mb-3">
                <label for="manzil">Manzil</label>
                  <input type="text" class="form-control" id="manzil" name="manzil" placeholder="1234 Main St" value="<?= set_value("manzil"); ?>">
              </div>
              <div class="col-md-4 mb-3">
                  <label for="pasport_file">Rasm</label>
                  <div class="custom-file">
                      <input type="file" name="photo_file" class="custom-file-input" id="customFile" >
                      <label class="custom-file-label" for="customFile">Photo file...</label>
              ...
              <div class="col-md-4 mb-3">
                ...
                <select class="custom-select d-block w-100" id="status" name="status">
                      <option value="2" <?= set_select('status', 2); ?>>Faol</option>
                      <option value="3" <?= set_select('status', 3); ?>>Nofaol</option>
                </select>
              </div>
              <div class="col-md-4 mb-3">
                <label for="malumoti">Ma'lumot</label>
                  <select class="custom-select d-block w-100" id="malumoti" name="malumoti">
                    <option value="1" <?= set_select('malumoti', 0); ?>>O'rta</option>
                    <option value="2" <?= set_select('malumoti', 1); ?> selected>Oliy</option>
                  </select>
              </div>
              <div class="col-lg-4 mb-3">
